<template>
    <div class="hsy-tooltip">
        <div class="outlet" @mouseover="autoShowWithModeTimeOut" @mouseleave="autoHideWithModeTimeOut" @click="autoShowWithMode">
            <slot name="outlet"></slot>
        </div>
        <div class="tooltip" @mouseover="autoTooltipMouseOverTimeOut" @mouseleave="autoTooltipMouseleaveTimeOut" :style="tooltipStyle">
            <div class="inner">
    ...
    export default {
        ...
        methods: {
            updateArrowStyle() {
                ...
                //auto
                if (this.placement.indexOf('auto') === 0) {
                    if (tooltipRect.top < 500) {
                        s.borderTopColor = 'rgba(255, 255, 255, 0.8)'
                        ...
                        s.borderLeftColor = 'transparent'
                        s.borderRightColor = 'transparent'
                        s.borderBottomColor = 'rgba(255, 255, 255, 0.8)'
                        s.borderLeftWidth = this.arrowWidth / 2
                        s.borderRightWidth = s.borderLeftWidth + 'px'
                        s.borderLeftWidth += 'px'
                ...
                if (this.placement.indexOf('left') === 0 || this.placement.indexOf('right') === 0) {
                    if (this.placement.indexOf('left') === 0) {
                        s.borderTopColor = 'transparent'
                        s.borderLeftColor = 'rgba(255, 255, 255, 0.8)'
                        s.borderRightColor = 'transparent'
                        s.borderBottomColor = 'transparent'
                        ...
                        s.borderTopColor = 'transparent'
                        s.borderLeftColor = 'transparent'
                        s.borderRightColor = 'rgba(255, 255, 255, 0.8)'
                        s.borderBottomColor = 'transparent'
            ...
            place() {
                ...
                // top|bottom
                if (this.placement.indexOf('top') === 0 || this.placement.indexOf('bottom') === 0 || this.placement.indexOf('auto') === 0) {
                    let top
                    let left
            ...
            autoShowWithModeTimeOut(evt){
                let $this = this;
                window.setTimeout(function() {
                    $this.autoShowWithMode(evt);
                }, 1000 * 1);
            },

            autoHideWithModeTimeOut(evt){
                this.isMouseOnTooltip = false;
                let $this = this;
                window.setTimeout(function() {
                    $this.autoHideWithMode(evt);
                }, 1000 * 1);
            },
            ...
            autoTooltipMouseOverTimeOut(evt){
                this.isMouseOnTooltip = true;
            },

            autoTooltipMouseleaveTimeOut(evt){
                this.isMouseOnTooltip = false;
